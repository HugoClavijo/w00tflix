...
<div class="panel-body">
 <form class="form-horizontal" action="create_detalle_videos.php" method="GET"  role="form" enctype="multipart/form-data">
								  ...
								  <div class="form-group">
								    <label for="descripcion" class="col-sm-2 control-label">Descripcion de video</label>
								    <div class="col-sm-9">
								      <input type="text" class="form-control" id="descripcion"  name="descripcion" placeholder="Ingrese la descripcion del video" >
								    </div>
								  </div>
