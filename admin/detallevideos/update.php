...
<div class="panel-body">
 <form class="form-horizontal" action="update_detalle_videos.php" method="GET"  role="form" enctype="multipart/form-data">


								  <div class="form-group">
								    <label class="col-sm-2 control-label" for="iddetalles">iddetalles</label>
								    <div class="col-sm-3 col-md-2">
								      <input class="form-control" id="iddetalles" readonly=""  name="iddetalles" type="text"  value="<?php print $iddetalles; ?> ">
								    </div>
								  </div>
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-9">
								      <input type="text" class="form-control" id="descripcion"  name="descripcion" placeholder="Ej. Jose Eduardo Perez" value="<?php print $descripcion; ?>">
								    </div>
								  </div>
