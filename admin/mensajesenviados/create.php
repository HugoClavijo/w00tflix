...
<div class="panel-body">
 <form class="form-horizontal" action="create_mensajes_enviados.php" method="GET"  role="form" enctype="multipart/form-data">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-3">
								      <input type="text" class="form-control" id="idusuario"  name="idusuario" placeholder="Id usuario" >
								    </div>
								  </div>


								  <div class="form-group">
								    <label for="mensaje" class="col-sm-2 control-label">Id usuario</label>
								    <div class="col-sm-9">
								      <input type="text" class="form-control" id="mensaje"  name="mensaje" placeholder="Ingresa  mensaje " >
								    </div>
								  </div>
