...
<center><p> **Mensaje enviado modificado con éxito** </p></center>
...
echo "<tbody>";
echo "<tr> ";
 echo "<td>".$idmensaje_enviado. " </td><td> " .$idusuario. " </td><td> " .$mensaje. " </td>";
?>
</table>
...
<a class="btn btn-primary" href="read_mensajes_enviados.php">Continuar</a>
