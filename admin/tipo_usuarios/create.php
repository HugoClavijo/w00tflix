...
<div class="panel-body">
 <form class="form-horizontal" action="create_tipo_usuarios.php" method="GET"  role="form" enctype="multipart/form-data">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-9">
								      <input type="text" class="form-control" id="detalle"  name="detalle" placeholder="Dale nombre  al nuevo tipo de usuario" >
								    </div>
								  </div>
